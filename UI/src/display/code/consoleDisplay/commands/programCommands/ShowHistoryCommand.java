...
public class ShowHistoryCommand implements consoleDisplay.commands.UiCommand {
    private final engineHolder.EngineHolder engineHolder;
    private final consoleDisplay.console.ConsoleIO io;

    public ShowHistoryCommand(engineHolder.EngineHolder engineHolder, consoleDisplay.console.ConsoleIO io) {
